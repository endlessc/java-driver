 ...
 *
 * <p>If {@link #customWhereClause()} is not empty, it completely replaces the WHERE clause:
 *
 * <pre>
 ...
 * </pre>
 *
 * This custom WHERE clause can contain named placeholders. In that case, the method must have a
